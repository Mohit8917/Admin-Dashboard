...
export default function GeneralSetting() {
  ...
  return (
    <div>
      <div className="flex flex-col p-7 text">
      ...
      <div className="flex justify-around">
        <div className="pr-60">
          ...
          <div className="w-[400px] h-[200px] flex flex-col bg-gray-100 gap-5 p-8 justify-center ">
            <p>Danger Zone</p>
            <div className=" flex flex-col gap-4">
              <p>
                Delete all the things and after deleting nothing will be
                recovered
              </p>
            </div>
            <Button
              btntext={"Delete Account"}
              className="bg-red-500 border-1 text-white rounded-lg p-2"
            />
          </div>
        </div>
        <div className="flex flex-col gap-19">
          <div className="bg-gray-100 h-[800px] w-[400px] p-4 rounded-xl">
              ...
              <div>
                ...
                <div className="pt-5 pl-20">
                  <Button
                    ...
                    className="border-2 p-2 bg-indigo-600 text-white rounded-lg ml-[20px]"
                  />
                </div>
              </div>
            </form>
